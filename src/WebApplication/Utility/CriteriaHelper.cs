...
namespace com.Sconit.Utility
{
    ...
    public class CriteriaHelper
    {
        ...
        {
            SetItemCriteria(criteria, propertyName, item, MatchMode.Anywhere);//default
        }
        ...
        public static void SetItemCategoryCriteria(DetachedCriteria criteria, string propertyName, CriteriaParam criteriaParam, MatchMode matchMode)
        {
            SetItemCategoryCriteria(criteria, propertyName, criteriaParam.ItemCategory, matchMode);
        }
        public static void SetItemCategoryCriteria(DetachedCriteria criteria, string propertyName, string itemCategory)
        {
            SetItemCategoryCriteria(criteria, propertyName, itemCategory, MatchMode.Anywhere);//default
        }
        public static void SetItemCategoryCriteria(DetachedCriteria criteria, string propertyName, string itemCategory, MatchMode matchMode)
        {
            if (itemCategory != null && itemCategory.Trim() != string.Empty)
            {
                criteria.Add(Expression.Like(propertyName, itemCategory, matchMode));
            }
        }
        #endregion
        ...
        public static object[] CollectMasterParam(IDictionary<string, string> dic, List<string> statusList, List<string> typeList, bool newItem)
        {
            ...
            string approvalStatus = (dic == null || !dic.ContainsKey("ApprovalStatus")) ? null : dic["ApprovalStatus"];
            string billFrom = (dic == null || !dic.ContainsKey("BillFrom")) ? null : dic["BillFrom"];
            string billTo = (dic == null || !dic.ContainsKey("BillTo")) ? null : dic["BillTo"];
            string relatedOrderNo = (dic == null || !dic.ContainsKey("RelatedOrderNo")) ? null : dic["RelatedOrderNo"];
            ...
            if (approvalStatus != null && approvalStatus != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("ApprovalStatus", approvalStatus));
                selectCountCriteria.Add(Expression.Eq("ApprovalStatus", approvalStatus));
            }
            if (billFrom != null && billFrom != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("BillFrom.Code", billFrom));
                selectCountCriteria.Add(Expression.Eq("BillFrom.Code", billFrom));
            }
            if (billTo != null && billTo != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("BillTo.Code", billTo));
                selectCountCriteria.Add(Expression.Eq("BillTo.Code", billTo));
            }
            if (relatedOrderNo != null && relatedOrderNo != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("RelatedOrderNo", relatedOrderNo));
                selectCountCriteria.Add(Expression.Eq("RelatedOrderNo", relatedOrderNo));
            }
        ...
        public static object[] CollectDetailParam(IDictionary<string, string> dic, List<string> statusList, List<string> typeList, bool newItem)
        {
            ...
            if (approvalStatus != null && approvalStatus != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("od.ApprovalStatus", approvalStatus));
                selectCountCriteria.Add(Expression.Eq("od.ApprovalStatus", approvalStatus));
            }
            if (billFrom != null && billFrom != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("od.BillFrom.Code", billFrom));
                selectCountCriteria.Add(Expression.Eq("od.BillFrom.Code", billFrom));
            }

            if (billTo != null && billTo != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("od.BillTo.Code", billTo));
                selectCountCriteria.Add(Expression.Eq("od.BillTo.Code", billTo));
            }

            if (relatedOrderNo != null && relatedOrderNo != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("od.RelatedOrderNo", relatedOrderNo));
                selectCountCriteria.Add(Expression.Eq("od.RelatedOrderNo", relatedOrderNo));
            }
