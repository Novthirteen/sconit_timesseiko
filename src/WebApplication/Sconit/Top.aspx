...
<body class="topbody" onload="onPageLoad()">
    ...
    <div style="width: 100%">
        <table class="toptable" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td class="toptdlogo">
                    <asp:Image ID="LeftImage" ImageAlign="Middle" NavigateUrl="~/Default.aspx" ImageUrl="~/Images/Logo_bak.png"
                        runat="server" />
                </td>
                ...
                <td class="toptdmid">
                    <table style="width: 100%; height: 100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td align="right">
                                <div style="background: url(Images/Banner_bg.png) no-repeat left; height: 30px; margin-bottom: 20px;max-width:220px;">
