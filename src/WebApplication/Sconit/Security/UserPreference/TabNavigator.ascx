...
<div class="AjaxClass  ajax__tab_default">
    <div class="ajax__tab_header">
        ...
        class='ajax__tab_outer'><span class='ajax__tab_inner'><span class='ajax__tab_tab'><asp:LinkButton ID="lbTheme" Text="${Security.UserPreference.Theme}" runat="server" OnClick="lbTheme_Click" /></span></span></span></span><!--<span id='tab_ScFav' runat="server"><span 
