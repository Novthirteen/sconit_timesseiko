...
public partial class Order_GoodsReceipt_AsnReceipt_Search : SearchModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (this.Action == "View")
            {
                ...
                IList<CodeMaster> deliverTypeList = GetDeliverTypeGroup();
                deliverTypeList.Insert(0, new CodeMaster()); //添加空选项
                this.ddlDeliverType.DataSource = deliverTypeList;
                this.ddlDeliverType.DataBind();
            }
    ...
    private object CollectDetailParam(bool isExport)
    {
        ...
        {
            selectCriteria.Add(Expression.In("ip.OrderType", new string[] { BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_CUSTOMERGOODS, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_SUBCONCTRACTING, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER }));
            selectCountCriteria.Add(Expression.In("ip.OrderType", new string[] { BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_CUSTOMERGOODS, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_SUBCONCTRACTING, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER }));
        }
        ...
        {
            selectCriteria.Add(Expression.Eq("ip.OrderType", this.ModuleType));
            selectCountCriteria.Add(Expression.Eq("ip.OrderType", this.ModuleType));
        }
        #endregion
        ...
        */
        ...
        if (this.dicParam["ApprovalStatus"] != string.Empty)
        {
            selectCriteria.Add(Expression.Eq("ApprovalStatus", this.dicParam["ApprovalStatus"]));
            selectCountCriteria.Add(Expression.Eq("ApprovalStatus", this.dicParam["ApprovalStatus"]));
        }
        if (this.dicParam["DeliverType"] != string.Empty)
        {
            selectCriteria.Add(Expression.Eq("ip.DeliverType", this.dicParam["DeliverType"]));
            selectCountCriteria.Add(Expression.Eq("ip.DeliverType", this.dicParam["DeliverType"]));
        }

        if (this.dicParam["ExpressNo"] != string.Empty)
        {
            selectCriteria.Add(Expression.Like("ip.ExpressNo", this.dicParam["ExpressNo"], MatchMode.Anywhere));
            selectCountCriteria.Add(Expression.Like("ip.ExpressNo", this.dicParam["ExpressNo"], MatchMode.Anywhere));
        }


        if (this.dicParam["TransportCompany"] != string.Empty)
        {
            selectCriteria.Add(Expression.Like("ip.TransportCompany", this.dicParam["TransportCompany"], MatchMode.Anywhere));
            selectCountCriteria.Add(Expression.Like("ip.TransportCompany", this.dicParam["TransportCompany"], MatchMode.Anywhere));
        }
    ...
    private object CollectMasterParam(bool isExport)
    {
        ...
        if (this.ModuleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT)
        {
            selectCriteria.Add(Expression.In("OrderType", new string[] { BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_CUSTOMERGOODS, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_SUBCONCTRACTING, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER }));
            selectCountCriteria.Add(Expression.In("OrderType", new string[] { BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_CUSTOMERGOODS, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_SUBCONCTRACTING, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER }));
        }
        else if (this.ModuleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION)
        {
            selectCriteria.Add(Expression.In("OrderType", new string[] { BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER }));
            selectCountCriteria.Add(Expression.In("OrderType", new string[] { BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION, BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER }));
        }
        else
        {
            selectCriteria.Add(Expression.Eq("OrderType", this.ModuleType));
            selectCountCriteria.Add(Expression.Eq("OrderType", this.ModuleType));
        }
        #endregion
    ...
    private void FillParameter()
    {
        ...
        this.dicParam["ApprovalStatus"] = this.ddlApprovalStatus.SelectedValue;

        this.dicParam["ExpressNo"] = this.tbExpressNo.Text.Trim();
        this.dicParam["TransportCompany"] = this.tbTransportCompany.Text.Trim();
        this.dicParam["DeliverType"] = this.ddlDeliverType.SelectedValue;
    }
    ...
    private IList<CodeMaster> GetDeliverTypeGroup()
    {
        IList<CodeMaster> deliverTypeGroup = new List<CodeMaster>();

        deliverTypeGroup.Add(GetDeliverType(BusinessConstants.CODE_MASTER_DELIVERTYPE_VALUE_EXPRESS));
        deliverTypeGroup.Add(GetDeliverType(BusinessConstants.CODE_MASTER_DELIVERTYPE_VALUE_OTHER));
        return deliverTypeGroup;
    }

    private CodeMaster GetDeliverType(string deliverType)
    {
        return TheCodeMasterMgr.GetCachedCodeMaster(BusinessConstants.CODE_MASTER_DELIVERTYPE, deliverType);
    }
