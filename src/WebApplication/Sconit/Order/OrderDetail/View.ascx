    ...
    <fieldset>
        ...
        <table class="mtable">
            ...
            <tr id="trPriceList" runat="server">
                ...
                <td class="td02">
                    <sc1:ReadonlyTextBox ID="tbPriceListFrom" runat="server" CodeField="PriceList.Code" />
                </td>
                <td class="td01">
                    <asp:Literal ID="lblPriceList" runat="server" Text="${MasterData.Order.OrderHead.PriceListTo}:" />
                </td>
                <td class="td02">
                    <sc1:ReadonlyTextBox ID="tbPriceListTo" runat="server" CodeField="PriceList.Code" />
                </td>
            </tr>
        </table>
    </fieldset>
