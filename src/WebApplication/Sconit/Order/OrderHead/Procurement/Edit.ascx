...
<fieldset>
    ...
    <asp:FormView ID="FV_Order" runat="server" DataSourceID="ODS_Order" DefaultMode="Edit"
        ...
        <EditItemTemplate>
            <table class="mtable">
                ...
                <tr>
                    <td class="td01">
                        <asp:Literal ID="lblRefOrderNo" runat="server" Text="${MasterData.Order.OrderHead.InquiryNo}:" />
                    </td>
                    <td class="td02">
                        <asp:TextBox ID="tbRefOrderNo" runat="server" Text='<%# Bind("ReferenceOrderNo") %>'></asp:TextBox>
                    </td>
                    <td class="td01">
                        <asp:Literal ID="lblExtOrderNo" runat="server" Text="${MasterData.Order.OrderHead.QuotationNo}:" />
                    </td>
                    <td class="td02">
                ...
                <tr>
                    <td class="td01">
                        <asp:Literal ID="lblConfirmOrderNo" runat="server" Text="${MasterData.Order.OrderHead.BookingNo}:" />
                    </td>
                    <td class="td02">
                        <asp:TextBox ID="tbConfirmOrderNo" runat="server" Text='<%# Bind("ConfirmOrderNo") %>'></asp:TextBox>
                    </td>
                    <td class="td01">
                        <asp:Literal ID="lblWindowTime" runat="server" Text="${MasterData.Order.OrderHead.WindowTime.Procurement}:" />
                    </td>
                    <td class="ttd02">
                        <asp:TextBox ID="tbWinTime" runat="server" Text='<%# Bind("WindowTime","{0:yyyy-MM-dd}") %>'
                            CssClass="inputRequired" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                    </td>
                </tr>
                <tr>
                    <td class="td01">
                    ...
                    <td class="td01">
                        <asp:Literal ID="lblCustomer" runat="server" Text="${MasterData.Order.OrderHead.Customer}:" />
                    </td>
                    <td class="td02">
                        <asp:TextBox ID="tbCustomer" runat="server" Text='<%# Bind("Customer") %>' />
                    </td>
                </tr>
                <tr>
                    <td class="td01">
                ...
                <tr>
                    <td class="td01">
                        <asp:Literal ID="lblBillFrom" runat="server" Text="${MasterData.Order.OrderHead.BillFrom.Procurement}:" />
                    </td>
                    <td class="td02">
    ...
    <div class="tablefooter">
        ...
        <sc1:Button ID="btnComplete" runat="server" Text="${MasterData.Order.Button.Complete}"
            CssClass="button2" OnClick="btnComplete_Click" FunctionId="CompleteOrder" Visible="false" />
