    ...
    <EditItemTemplate>
        <table class="mtable">
            ...
            <tr>
                ...
                <td class="td01">
                    <asp:Literal ID="ltlRefOrderNo2" runat="server" Text="${InProcessLocation.IpNo}:" />
                </td>
                <td class="td02">
                    <asp:TextBox ID="tbRefOrderNo2" runat="server" ReadOnly="true" Text='<%# Bind("ExternalReceiptNo") %>' />
                </td>
            </tr>
            <tr>
                <td class="td01">
