...
public partial class Order_GoodsReceipt_OrderReceipt_ReceiptItemList : BusinessModuleBase
{
    ...
    protected void btnReceive_Click(object sender, EventArgs e)
    {
        ...
        {
            if (this.CacheResolver.OrderType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION)
            {
                this.lblRefNo.Text = "客户收货确认不能为空";
            }
            else
            {
                this.lblRefNo.Text = "供应商发货单号不能为空";
            }
            return;
        }
        try
    ...
    protected override void BindTransformer()
    {
        ...
        this.ucTransformer.TransformerType = BusinessConstants.TRANSFORMER_MODULE_TYPE_RECEIVE;
    }
    ...
    private void InitialUI()
    {
        ...
        if (this.CacheResolver.OrderType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION)
        {
            this.lblRefNo.Text = "客户收货确认:";
        }
        else
        {
            this.lblRefNo.Text = "供应商发货单号:";
        }
