...
public partial class Order_OrderIssue_EditMain : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucViewShipList.RefreshListEvent += new System.EventHandler(this.RefreshList_Render);
    ...
    {
        this.ucViewShipList.InitPageParameter(this.ucViewShipList.IpNo, this.ucViewShipList.IsPrintASN);
    }
