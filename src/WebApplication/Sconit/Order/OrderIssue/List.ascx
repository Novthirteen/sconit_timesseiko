    ...
    <div class="GridView">
        <asp:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" OnRowDataBound="GV_List_RowDataBound" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Order.OrderHead.PartyFrom.Region}"
               ...
               <asp:TemplateField HeaderText="${MasterData.Order.OrderHead.HasPaymentBeforeDelivery}" SortExpression="BoolField2">
                    <ItemTemplate>
                        <asp:CheckBox ID="cbHasPaymentBeforeDelivery" runat="server"  Enabled="false"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Order.OrderHead.CreateUser}" SortExpression="Reports.SalesOrderTracking.CreateUser">
                    <ItemTemplate>
