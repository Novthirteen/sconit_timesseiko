    ...
    <div class="GridView">
        <cc1:gridview id="GV_List" runat="server" autogeneratecolumns="False" datakeynames="ReceiptNo"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Order.OrderHead.OrderNo.Procurement}" >
                    <ItemTemplate>
                        <asp:Label ID="lblProcurementNos" runat="server"  />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Order.OrderHead.OrderNo.Distribution}" >
                    <ItemTemplate>
                        <asp:Label ID="lblDistributionNos" runat="server"  />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${Common.Business.Region}" SortExpression="PartyFrom.Name">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="${InProcessLocation.PartyTo}" SortExpression="PartyTo.Code">
                    <ItemTemplate>
                        <asp:Label ID="lblPartyTo" runat="server" Text=' <%# DataBinder.Eval(Container.DataItem, "PartyTo.Code")%>'
        ...
        <cc1:gridview id="GV_List_Detail" runat="server" autogeneratecolumns="False" datakeynames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.Business.Uom}" SortExpression="OrderLocationTransaction.Uom.Code">
                    <ItemTemplate>
                        <asp:Label ID="lblUom" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "OrderLocationTransaction.Uom.Name")%>' 
                ...
                <asp:BoundField DataField="ShippedQty" HeaderText="${Common.Business.ShippedQty}" SortExpression="ShippedQty"  DataFormatString="{0:0.########}"/>
