    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Flow.FlowDetail.Item.Category}">
                    <ItemTemplate>
                        <asp:Label ID="lblItemCategory" runat="server" Text='<%# Bind("Item.Desc1") %>'
                           />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Flow.FlowDetail.Item.Spec}">
                    <ItemTemplate>
                        <asp:Label ID="lblItemSpec" runat="server" Text='<%# Bind("Item.Spec") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Flow.FlowDetail.Brand}">
                    <ItemTemplate>
                        <asp:Label ID="lblItemBrand" runat="server" Text='<%# Bind("Brand") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
