            ...
            <fieldset>
                ...
                <table class="mtable">
                    <tr>
                        ...
                        <td class="td01">
                            <asp:Literal ID="lblOrderTemplate" runat="server" Text="${MasterData.Flow.SalesOrderTemplate}:" />
                        </td>
                        <td class="td02">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="lblBillFrom" runat="server" Text="${MasterData.Flow.BillFrom.Distribution}:" />
                        </td>
                        <td class="td02">
