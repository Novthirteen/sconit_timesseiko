...
<div class="GridView">
    <asp:GridView ID="GV_List" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$Resources:Language,MasterDataItemCategoryDesc1%>">
                <ItemTemplate>
                    <asp:Label ID="lblItemCategoryDesc1" runat="server" Text='<%# Bind("ItemCategoryDesc1") %>' />
                </ItemTemplate>
            </asp:TemplateField>
            
            <asp:TemplateField HeaderText="<%$Resources:Language,MasterDataItemSpec%>">
                <ItemTemplate>
                    <asp:Label ID="lblItemSpec" runat="server" Text='<%# Bind("ItemSpec") %>' />
                </ItemTemplate>
            </asp:TemplateField>
            
            <asp:TemplateField HeaderText="<%$Resources:Language,MasterDataItemBrand%>">
                <ItemTemplate>
                    <asp:Label ID="lblItemBrand" runat="server" Text='<%# Bind("ItemBrand") %>' />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="<%$Resources:Language,MasterDataSupplierItemCode%>">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="CurrentQty">
                <ItemTemplate>
                    ...
                    <asp:RangeValidator ID="rvCurrentQty" ControlToValidate="tbCurrentQty" runat="server"
                        Display="Dynamic" ErrorMessage="*" MaximumValue="999999999" MinimumValue="0" Enabled="false"
                        Type="Double" />
                </ItemTemplate>
            </asp:TemplateField>
