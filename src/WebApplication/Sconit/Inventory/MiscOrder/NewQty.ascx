    ...
    function GenerateItem(obj) {
        ...
        if ($(obj).val() != "") {
            ...
            function OnSucceeded(result, eventArgs) {
                ...
                $('#' + parentId + 'tbItemSpecText').attr('value', result.Spec);
                $('#' + parentId + 'tbItemBrandText').attr('value', result.Brand);
        ...
        <asp:GridView ID="MiscOrderDetailsGV" runat="server" AllowPaging="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Order.OrderDetail.Item.Spec}" >
                    <ItemTemplate>
                        <asp:TextBox ID="tbItemSpecText" runat="server" Text='<%# Eval("Item.Spec")%>' onfocus="this.blur();"  Width="150px"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Order.OrderDetail.Item.Brand}" >
                    <ItemTemplate>
                        <asp:TextBox ID="tbItemBrandText" runat="server" Text='<%# Eval("Item.Brand")%>' onfocus="this.blur();" Width="200px"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Order.OrderDetail.Uom}">
                    <ItemTemplate>
                        <asp:Label ID="tvlItemUom" runat="server" Visible="false" />
                        <asp:TextBox ID="tblItemUomText" runat="server" Width="80px"  Text='<%# Bind("Item.Uom.Code") %>'
                            Visible="true" onfocus="this.blur();" />
                    </ItemTemplate>
                </asp:TemplateField>
