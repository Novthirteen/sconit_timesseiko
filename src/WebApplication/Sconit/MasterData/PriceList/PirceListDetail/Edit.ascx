        ...
        <EditItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="lblItemDescription" runat="server" Text="${MasterData.Item.Description}:" />
                        </td>
                        <td class="td02">
                            <asp:TextBox ID="tbItemDescription" runat="server" ReadOnly="true" />
                            <asp:CustomValidator ID="cvItemDescription" runat="server" ControlToValidate="tbItemDescription" Display="Dynamic"
                                ErrorMessage="*" ValidationGroup="vgSave" OnServerValidate="CV_ServerValidate" />
                        </td>
                        <td class="td01">
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tbUnitPrice" runat="server" Text='<%#Bind("UnitPrice","{0:0.00}") %>'
                    ...
                    <tr>
                        <td class="td01">
                            ...
                            <asp:Literal ID="lblItemSpec" runat="server" Text="${MasterData.Item.Spec}:" />
                          
                        </td>
                        <td class="td02">
                             <asp:TextBox ID="tbItemSpec" runat="server"  ReadOnly="true"/>
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="lblItemBrand" runat="server" Text="${MasterData.Item.Brand}:" />
                        </td>
                        <td class="td02">
                            <asp:TextBox ID="tbItemBrand" runat="server"  ReadOnly="true"/>
                        </td>
                        <td class="td01">
