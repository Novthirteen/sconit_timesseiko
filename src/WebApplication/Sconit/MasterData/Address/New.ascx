        ...
        <InsertItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            ...
                            <asp:RangeValidator ID="rvSequence" runat="server" ControlToValidate="tbSequence"
                                ...
                                MinimumValue="1" MaximumValue="100000" ValidationGroup="vgSave" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="lblAddress2" runat="server" Text="${MasterData.Address.Address2}:" />
                        </td>
                        <td class="td02" colspan="3">
                            <asp:TextBox ID="tbAddress2" runat="server" Text='<%# Bind("Address2") %>' Width="75%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
