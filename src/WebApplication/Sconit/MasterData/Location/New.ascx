            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tbType" runat="server" Text='<%#Bind("Type") %>' />
                        </td>
                        <td class="td01">
                    ...
                    <tr>
                        ...
                        <td class="td01">
                            <%--<asp:Literal ID="ltlEnableAdv" runat="server" Text="${MasterData.Location.EnableAdvWM}:" />--%>
                        </td>
                        <td class="td02">
                            <%--<asp:CheckBox ID="cbEnableAdv" runat="server" Checked='<%#Bind("EnableAdvWM") %>' />--%>
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
