<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Reports_OrderTracking_Search" %>
...
<fieldset>
    <table class="mtable">
        <tr>
            <td class="td01">
                <asp:Literal ID="lblOrderNo" runat="server" Text="${Reports.OrderTracking.OrderNo}:" />
            </td>
            <td class="td02">
        ...
        <tr>
            <td class="td01">
                <asp:Literal ID="lblEffectiveDateFrom" runat="server" Text="${Reports.OrderTracking.EffectiveDateFrom}:" />
            </td>
            <td class="td02">
            ...
            <td class="td01">
                <asp:Literal ID="lblEffectiveDateTo" runat="server" Text="${Reports.OrderTracking.EffectiveDateTo}:" />
            </td>
            <td class="td02">
