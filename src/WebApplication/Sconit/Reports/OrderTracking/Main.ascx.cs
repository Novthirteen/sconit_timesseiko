...
public partial class Reports_OrderTracking_Main : MainModuleBase
{
    ...
    void ucList_DetailEvent(object sender, EventArgs e)
    {
        ...
        this.ucDetail.SetSearchCriteria((DetachedCriteria)((object[])sender)[0], (DetachedCriteria)((object[])sender)[1], (IDictionary<string, string>)((object[])sender)[2], (int)(((object[])sender)[3]));
    }
}
