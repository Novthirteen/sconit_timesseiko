...
public partial class Reports_ActFundsAging_Main : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucDetail.BillDetailEvent += new EventHandler(ucDetail_BillDetailEvent);
        if (!IsPostBack)
        {
    ...
    void ucDetail_BillDetailEvent(object sender, EventArgs e)
    {
        this.ucBillList.Visible = true;
        //this.ucBillList.SetSearchCriteria((DetachedCriteria)((object[])sender)[0], (DetachedCriteria)((object[])sender)[1], (IDictionary<string, string>)((object[])sender)[2]);
        this.ucBillList.InitPageParameter((DetachedCriteria)((object[])sender)[0]);
