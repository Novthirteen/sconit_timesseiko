...
public partial class Reports_ActFundsAging_Search : SearchModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.lblParty.Text = "${Reports.ActFundsAging.PartyFrom}:";
        ...
        {
            this.lblParty.Text = "${Reports.ActFundsAging.PartyTo}:";
    ...
    {
        DetachedCriteria selectCriteria = DetachedCriteria.For(typeof(ActFundsAgingView));
        DetachedCriteria selectCountCriteria = DetachedCriteria.For(typeof(ActFundsAgingView))
