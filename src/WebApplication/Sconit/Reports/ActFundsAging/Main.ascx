<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Reports_ActFundsAging_Main" %>
...
<%@ Register Src="~\Reports\ActFunds\BillList.ascx" TagName="BillList" TagPrefix="uc2" %>
