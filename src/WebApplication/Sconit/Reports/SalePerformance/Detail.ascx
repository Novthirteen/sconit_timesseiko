<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Reports_SalePerformance_Detail" %>
    ...
    <fieldset>
        ...
        <div class="GridView">
            <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                ...
                <Columns>
                    <asp:TemplateField SortExpression="OrderHead.OrderNo" >
                        <ItemTemplate>
