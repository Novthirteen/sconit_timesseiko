...
public partial class Reports_LocTrans_List : ReportModuleBase
{
    ...
    protected void GV_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Item item = TheItemMgr.LoadItem(locationTransactionView.Item);
            ((Label)(e.Row.FindControl("lblItemSpec"))).Text = item.Spec;
            ((Label)(e.Row.FindControl("lblItemBrand"))).Text = item.Brand;
        }
    }
    ...
    protected override void SetCriteria()
    {
        ...
        CriteriaHelper.SetPartyCriteria(selectCriteria,"PartyTo",this._criteriaParam);
        #endregion
        ...
        if (!this._criteriaParam.ClassifiedUser && !this._criteriaParam.ClassifiedDate)
        {
            ...
            projectionList.Add(Projections.GroupProperty("PartyFrom").As("PartyFrom"));
        }
