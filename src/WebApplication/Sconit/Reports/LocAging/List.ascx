    ...
    <div class="GridView">
        <sc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" SkinID="GV"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.Business.Item.Category}" SortExpression="Item">
                    <ItemTemplate>
                        <asp:Label ID="lblItemDescription" runat="server" Text='<%# Eval("Item.Description")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="${Common.Business.ItemSpec}" SortExpression="Item">
                    <ItemTemplate>
                        <asp:Label ID="lblItemSpec" runat="server" Text='<%# Eval("Item.Spec")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Common.Business.ItemBrand}" SortExpression="Item">
                    <ItemTemplate>
