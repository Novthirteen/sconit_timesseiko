...
public partial class Reports_SalesOrderTracking_Search : SearchModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.lblParty.Text = "${Reports.SalesOrderTracking.PartyTo}:";
    ...
    {
        DetachedCriteria selectCriteria = DetachedCriteria.For(typeof(SalesOrderTrackingView));
        DetachedCriteria selectCountCriteria = DetachedCriteria.For(typeof(SalesOrderTrackingView))
        ...
        else
        {
            ...
            selectCriteria, selectCountCriteria, (this.tbParty != null ? this.tbParty.Text : null), BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION, this.CurrentUser.Code);
        }
