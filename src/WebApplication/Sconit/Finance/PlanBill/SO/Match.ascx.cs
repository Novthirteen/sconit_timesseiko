...
public partial class Finance_PlanBill_SO_Match : ModuleBase
{
    ...
    private List<Transformer> ConvertPlannedBillToTransformer(IList<PlannedBill> plannedBillList)
    {
        ...
        foreach (PlannedBill plannedBill in plannedBillList)
        {
            ...
            transformer.ItemSpec = plannedBill.Item.Spec;
            transformer.ItemBrand = plannedBill.Item.Brand;
            if (plannedBill.Item.ItemCategory != null)
            {
                transformer.ItemCategoryCode = plannedBill.Item.ItemCategory.Code;
                transformer.ItemCategoryDesc1 = plannedBill.Item.ItemCategory.Desc1;
                transformer.ItemCategoryDesc2 = plannedBill.Item.ItemCategory.Desc2;
            }
