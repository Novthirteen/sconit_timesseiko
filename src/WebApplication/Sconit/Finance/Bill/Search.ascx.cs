    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            if (partyCode != string.Empty)
            {
                ...
                else if (this.ModuleType == BusinessConstants.BILL_TRANS_TYPE_SO && !IsSupplier)
                {
                    selectCriteria.Add(Expression.Eq("pt.Code", partyCode));
                    selectCountCriteria.Add(Expression.Eq("pt.Code", partyCode));
                }
            }
            else
            {
                ...
                {
                    SecurityHelper.SetPartyToSearchCriteria(selectCriteria, selectCountCriteria, (this.tbPartyCode != null ? this.tbPartyCode.Text : null), BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION, this.CurrentUser.Code);
                }
            }
