...
namespace com.Sconit.Entity
{
    public static class BusinessConstants
    {
        ...
        public static readonly string CODE_PREFIX_ASN = "TSK";
        public static readonly string CODE_PREFIX_ASN_ELSE = "ASN";
        ...
        public static readonly string CODE_PREFIX_ORDER = "TSC";
        public static readonly string CODE_PREFIX_PAY = "PAY";
        ...
        public static readonly string ENTITY_PREFERENCE_CODE_IS_SHOW_DISCOUNT = "IsShowDiscount";
        ...
        public static readonly string CODE_MASTER_DELIVERTYPE = "DeliverType";
        public static readonly string CODE_MASTER_DELIVERTYPE_VALUE_EXPRESS = "Express";
        public static readonly string CODE_MASTER_DELIVERTYPE_VALUE_OTHER = "Other";
        ...
        public static readonly string CODE_MASTER_APPROVALSTATUS = "ApprovalStatus";
        public static readonly string CODE_MASTER_APPROVALSTATUS_PENDING = "Pending";
        public static readonly string CODE_MASTER_APPROVALSTATUS_REJECTED = "Rejected";
        public static readonly string CODE_MASTER_APPROVALSTATUS_APPROVED = "Approved";

        public static readonly string CODE_MASTER_ROUND_OPTION = "RoundUpOption";
        public static readonly string CODE_MASTER_ROUND_OPTION_UP = "1";
        public static readonly string CODE_MASTER_ROUND_OPTION_NOT_ROUND = "0";
        public static readonly string CODE_MASTER_ROUND_OPTION_DOWN = "-1";
