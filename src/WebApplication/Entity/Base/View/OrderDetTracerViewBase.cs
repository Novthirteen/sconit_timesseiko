...
{
    [Serializable]
    public abstract class OrderDetTracerViewBase : EntityBase
    {
        ...
        private string _orderTracerCode;
        public string OrderTracerCode
        {
            get
            {
                return _orderTracerCode;
            }
            set
            {
                _orderTracerCode = value;
            }
        }
        private string _orderTracerItem;
        public string OrderTracerItem
        {
            get
            {
                return _orderTracerItem;
            }
            set
            {
                _orderTracerItem = value;
            }
        }
        ...
        {
            OrderDetTracerViewBase another = obj as OrderDetTracerViewBase;
