...
namespace com.Sconit.Entity.MasterData
{
    ...
    public abstract class OrderDetailBase : EntityBase
    {
        ...
        private Decimal _includeTaxPrice;
        public Decimal IncludeTaxPrice
        {
            get
            {
                return _includeTaxPrice;
            }
            set
            {
                _includeTaxPrice = value;
            }
        }
        private Decimal _includeTaxTotalPrice;
        public Decimal IncludeTaxTotalPrice
        {
            get
            {
                return _includeTaxTotalPrice;
            }
            set
            {
                _includeTaxTotalPrice = value;
            }
        }
        private Decimal _excludeTotalPrice;
        public Decimal ExcludeTotalPrice
        {
            get
            {
                return _excludeTotalPrice;
            }
            set
            {
                _excludeTotalPrice = value;
            }
        }
        private Decimal _excludeTaxPrice;
        public Decimal ExcludeTaxPrice
        {
            get
            {
                return _excludeTaxPrice;
            }
            set
            {
                _excludeTaxPrice = value;
            }
        }
