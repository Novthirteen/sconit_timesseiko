...
namespace com.Sconit.Service.Distribution
{
    public interface IInProcessLocationMgr : IInProcessLocationBaseMgr
    {
        ...
        void UpdateInProcessLocation(string ipNo, string deliverType, string transportCompany, string expressNo, string deliverDate, User currentUser);
        ...
        void ApproveInPorcessLocation(InProcessLocation inProcessLocation, string userCode);

        void ApproveInPorcessLocation(InProcessLocation inProcessLocation, User user);

        void ApproveInPorcessLocation(string ipNo, string userCode);

        void ApproveInPorcessLocation(string ipNo, User user);

        void RejectInPorcessLocation(InProcessLocation inProcessLocation, string userCode);

        void RejectInPorcessLocation(InProcessLocation inProcessLocation, User user);

        void RejectInPorcessLocation(string ipNo, string userCode);

        void RejectInPorcessLocation(string ipNo, User user);
