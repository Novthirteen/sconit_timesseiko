...
namespace com.Sconit.Service.MasterData
{
    public interface IOrderMgr
    {
        ...
        void CancelOrder(string orderNo, User user, string cancelReason);
        ...
        void VoidOrder(OrderHead orderHead, string userCode);

        void VoidOrder(string orderNo, string userCode);

        void VoidOrder(OrderHead orderHead, User currentUser);

        void VoidOrder(string orderNo, User currentUser);

        void RejectOrder(string orderNo, User user);

        void RejectOrder(string orderNo, string userCode);

        void RejectOrder(OrderHead orderHead, User user);

        void RejectOrder(OrderHead orderHead, string userCode);

        void ApproveOrder(OrderHead orderHead, string userCode);

        void ApproveOrder(OrderHead orderHead, User user);

        void ApproveOrder(string orderNo, string userCode);

        void ApproveOrder(string orderNo, User user);

        //重新计价
        void RecalculatePrice(string orderNo, User user);
    }
}
