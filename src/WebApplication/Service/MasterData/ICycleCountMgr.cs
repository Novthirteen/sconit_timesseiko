...
namespace com.Sconit.Service.MasterData
{
    public interface ICycleCountMgr : ICycleCountBaseMgr
    {
        ...
        void CheckHuExistThisCount(string huId);
        ...
        IList<CycleCountResult> CalcCycleCount(string orderNo, string phyCntGroupBy, bool listShortage, bool listProfit, bool listEqual, IList<string> binList, IList<string> itemList);
        ...
        IList<CycleCountResult> ListCycleCountResultDetail(string orderNo, bool listShortage, bool listProfit, bool listEqual, string bin, string item);
