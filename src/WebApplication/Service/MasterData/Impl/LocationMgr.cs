...
namespace com.Sconit.Service.MasterData.Impl
{
    ...
    public class LocationMgr : LocationBaseMgr, ILocationMgr
    {
        ...
        public void InventoryRepackIn(RepackDetail repackDetail, User user)
        {
            ...
            this.locationTransactionMgrE.RecordLocationTransaction(inventoryOutTransaction, BusinessConstants.CODE_MASTER_LOCATION_TRANSACTION_TYPE_VALUE_ISS_REPACK, user);
            #endregion
        }
        ...
        public InventoryTransaction InventoryRepackOut(RepackDetail repackDetail, Location location, int? plannedBillId, User user)
        {
            ...
            this.locationTransactionMgrE.RecordLocationTransaction(inventoryInTransaction, BusinessConstants.CODE_MASTER_LOCATION_TRANSACTION_TYPE_VALUE_RCT_REPACK, user);
            #endregion
        ...
        [Transaction(TransactionMode.Requires)]
        public IList<InventoryTransaction> InspectIn(LocationLotDetail locationLotDetail, Location locIn, User user, bool needSettle, string inspectNo)
        {
            return InspectIn(locationLotDetail, locIn, null, user, needSettle, inspectNo);
        }
