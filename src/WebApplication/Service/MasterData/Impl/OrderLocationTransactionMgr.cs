...
namespace com.Sconit.Service.MasterData.Impl
{
    ...
    public class OrderLocationTransactionMgr : OrderLocationTransactionBaseMgr, IOrderLocationTransactionMgr
    {
        ...
        public override void DeleteOrderLocationTransaction(IList<OrderLocationTransaction> entityList)
        
        {
            IList<int> oltIdList =  entityList.Select(e=>e.Id).ToList<int>();
            orderTracerMgrE.DeleteOrderTracerByOrderLocationTransaction((IList<int>)oltIdList);
            base.DeleteOrderLocationTransaction(entityList);
        }
        ...
        public IList<OrderLocationTransaction> GetOrderLocationTransaction(string orderNo, string itemCode, string ioType)
        {
            DetachedCriteria criteria = DetachedCriteria.For(typeof(OrderLocationTransaction));
            criteria.CreateAlias("OrderDetail", "od");
            criteria.CreateAlias("od.OrderHead", "oh");
