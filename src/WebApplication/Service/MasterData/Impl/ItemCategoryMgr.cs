...
namespace com.Sconit.Service.MasterData.Impl
{
    ...
    public class ItemCategoryMgr : ItemCategoryBaseMgr, IItemCategoryMgr
    {
        ...
        public ItemCategory CheckAndLoadItemCategory(string itemCategoryCode)
        {
            ItemCategory itemCategory = this.LoadItemCategory(itemCategoryCode);
            if (itemCategory == null)
            {
                throw new BusinessErrorException("ItemCategory.Error.ItemCategoryCodeNotExist", itemCategoryCode);
            }
