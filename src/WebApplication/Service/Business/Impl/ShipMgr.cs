            ...
            if (resolver.CodePrefix == BusinessConstants.CODE_PREFIX_ORDER)
            {
                ...
                if (!isHasOrderNo)
                {
                    ...
                    if (resolver.OrderType != BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT
                        && resolver.OrderType != BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION
                        && resolver.OrderType != BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER)
                    {
