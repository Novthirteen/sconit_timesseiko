    ...
    public class SetDetailMgr : ISetDetailMgr
    {
        ...
        public void MatchHuByItem(Resolver resolver, Hu hu)
        {
            ...
            if (!MatchByItem(resolver, hu))
            {
                ...
                else //允许新增明细
                {
                    ...
                    transformer.ItemSpec = hu.Item.Spec;
                    transformer.ItemBrand = hu.Item.Brand;
                    if (hu.Item.ItemCategory != null)
                    {
                        transformer.ItemCategoryCode = hu.Item.ItemCategory.Code;
                        transformer.ItemCategoryDesc1 = hu.Item.ItemCategory.Desc1;
                        transformer.ItemCategoryDesc2 = hu.Item.ItemCategory.Desc2;
                    }
        ...
        public void SetMateria(Resolver resolver)
        {
            ...
            IList<ProductLineInProcessLocationDetail> productLineIpList =
                productLineInProcessLocationDetailMgrE.GetProductLineInProcessLocationDetail(resolver.Code, BusinessConstants.CODE_MASTER_STATUS_VALUE_CREATE);
            #endregion
        ...
        private Hu ResolveAndCreateHu(string barCode, IList<int> orderLocationTransactionIdList)
        {
            ...
            EntityPreference entityPreference = this.entityPreferenceMgrE.LoadEntityPreference(BusinessConstants.ENTITY_PREFERENCE_CODE_COMPANY_ID_MARK); //企业标识位
        ...
        {
            IList<OrderDetail> orderDetailList = orderMgrE.TransferFlow2Order(flow).OrderDetails;
            return ResolveAndCreateHu(barCode, orderDetailList);
        }
