    ...
    public class RepRequisitionOrderContractMgr : RepTemplate1
    {
        ...
        protected override void FillValuesImpl(String templateFileName, IList<object> list)
        {
            ...
            foreach (OrderDetail orderDetail in orderDetails)
            {
                ...
                //Unit Price
                this.SetRowCell(pageIndex, rowIndex, 6, orderDetail.UnitPriceAfterDiscount == null ? "" : orderDetail.UnitPriceAfterDiscount.Value.ToString("0.00"));
                //Total //=G3*E3
                this.SetRowCell(pageIndex, rowIndex, 7, orderDetail.UnitPriceAfterDiscount == null ? 0 : Double.Parse((orderDetail.OrderedQty * orderDetail.UnitPriceAfterDiscount.Value).ToString("0.00")));
