...
namespace com.Sconit.Service.Report.Impl
{
     ...
     */
    [Transactional]
    public class RepBarCodeMgr : RepTemplate2
    {
        ...
        protected override void FillValuesImpl(String templateFileName, IList<object> list)
        {
            ...
            foreach (Hu hu in huList)
            {
                if (hu.Item.Type.Equals("M") || hu.Item.Type.Equals("P")) //成品
                {
                    ...
                    // 生产日期
                    this.SetRowCell(pageIndex, 7, 1, hu.CreateDate.ToString("yyyy-MM-dd"));
                    ...
                    // 打印日期
                    this.SetRowCell(pageIndex, 10, 1, DateTime.Now.ToString("yyyy-MM-dd"));
                    //打印人
